"""
Purpose: Azure OpenAI LLM Provider implementation.

Responsibilities:
- Implement AIProvider for Azure OpenAI instances.
...
class AzureOpenAIProvider(AIProvider):
    ...
    async def health(self) -> Dict[str, Any]:
        has_key = bool(self.settings.AZURE_OPENAI_KEY and self.settings.AZURE_OPENAI_ENDPOINT)
        return {

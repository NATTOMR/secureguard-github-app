"""
Purpose: Local Ollama LLM Provider implementation.

Responsibilities:
- Implement AIProvider for local Ollama instances.
...
class OllamaProvider(AIProvider):
    ...
    async def health(self) -> Dict[str, Any]:
        url = self.settings.OLLAMA_URL or self.settings.OLLAMA_BASE_URL
        return {
